package com.example.android.gmovie.MovieUtils;

import android.text.TextUtils;
import android.util.Log;

import com.example.android.gmovie.Movie;
    ...
    private static List<Movie> extractFeatureFromJson(String movieJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                String moviePoster = "http://image.tmdb.org/t/p/w185/"+currentMovies.getString("poster_path");
